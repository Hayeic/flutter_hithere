  ...
  userLogin(BuildContext context)async{
    ...
    if(_formKey.currentState.validate()){
      try{
        ...
        AuthResult resultLogIn = await _authentication.LoginUser(user:  User(email: emailCtrl.value.text,password: passwordCtrl.value.text));
        FirebaseUser user = resultLogIn.user;
        setState(() {
          loader = false;
        });
