  ...
  userSingup(BuildContext context)async{
    ...
    if(_formKey.currentState.validate()){
      try{
        ...
        //FirebaseUser user = await _authentication.SignupUser(user: User(email: emailCtrl.value.text.password, password: passwordCtrl.value.text));
        AuthResult resultSignUp = await _authentication.SignupUser(user:  User(email: emailCtrl.value.text,password: passwordCtrl.value.text));
        FirebaseUser user = resultSignUp.user;
